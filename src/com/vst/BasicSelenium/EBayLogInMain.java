...
public class EBayLogInMain {
	...
	public static void main(String[] args) {
		...
		//UserId
		chdriver.findElement(By.cssSelector("#userid")).sendKeys("priyangasubbiah1990@gmail.com");
		
		//Password
		chdriver.findElement(By.cssSelector("#pass")).sendKeys("Priyanga13");
